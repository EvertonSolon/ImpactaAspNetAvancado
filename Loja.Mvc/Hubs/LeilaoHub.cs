...
namespace Loja.Mvc.Hubs
{
    public class LeilaoHub : Hub
    {
        ...
        public void EnviarJoinha(string nomeParticipante, string connectdionIdDestinatario)
        {
            Clients.Client(connectdionIdDestinatario).receberJoinha(nomeParticipante);
        }
    }
}