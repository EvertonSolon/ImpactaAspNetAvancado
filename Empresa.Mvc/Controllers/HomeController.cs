...
namespace Empresa.Mvc.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        //private readonly _configuracaoTipoAu
        ...
        public IActionResult Login(LoginViewModel viewModel)
        {
            ...
            var contato = _contexto.Contatos.Where(x => x.Email.Equals(viewModel.Email) &&
                _protectorProvider.Unprotect(x.Senha) == viewModel.Senha).SingleOrDefault();
